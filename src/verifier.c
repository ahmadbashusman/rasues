...
/* config */
char dst_host[16] = "192.168.0.2";	 // 15 characters for IPv4 plus \0
...
char* reference_pcr_file_path = "update-reference-pcrs.txt";
...
static CHARRA_RC create_attestation_request(
	...
	*attestation_request = req;
	...
	charra_log_info("[TIME] Nonce Generation total time %f secs", total_t);
